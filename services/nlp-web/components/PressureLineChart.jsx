...
// Expects data: [{ timestamp, pressure }, ...]
export default function PressureLineChart({ data, timeUnit = "minute" }) {
    ...
    return (
        <div style={{ width: "100%", height: 320 }}>
            <h3 className="font-semibold mb-2">Pressure Over Time (hPa)</h3>
